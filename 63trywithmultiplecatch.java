...
//    	}
    	...
    	catch(Exception e)   //Exception is the parent class(of all types of exceptions).We must put parent class at the end catch block. If it is above child then always parent will catch.
    	{
